...
public class Group {
     ...
     *
     * Двигают её только триггеры БД: на любое изменение availability (V4) и на
     * смену {@link #showParticipants} (V25) — единственной настройки группы,
     * которая доходит до ответа теплокарты. Из Java версию писать не нужно:
     * триггер перепишет значение своим.
     */
